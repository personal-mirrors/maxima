...
(defparameter $testsuite_files
	...
	"rtest_polynomialp"
        ((mlist simp) "rtest_limit_extra" 
          ((mlist simp)  42 52 53 59 61 64 67 70 80 82 83 84 87 89 90 91 
                         94 96 98 100 102 103 104 106 108 111
                         124 125 126 127 132 133 135 136 137 139 187))
        "rtest_gcd"
          ))
...
;; Tested with acl 10.1
    ...
    ((mlist simp) "rtest_to_poly_solve"
     ...
     #+clisp
     ((mlist simp) 48 55 64 74 80 83 102 116 131 133 137 140 141 147 166 167 168 183 184 210 216 240 242 245 265 293 312 319 320 322)
     #+gcl
