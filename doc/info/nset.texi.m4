...
See also @mrefdot{cartesian_product_list}
...
@anchor{cartesian_product_list}
@deffn {Function} cartesian_product_list (@var{b_1}, ... , @var{b_n})
Returns a list of lists of the form @code{[@var{x_1}, ..., @var{x_n}]}, where
@var{x_1}, ..., @var{x_n} are elements of the lists @var{b_1}, ... , @var{b_n}, respectively,
comprising all possible combinations of the elements of @var{b_1}, ... , @var{b_n}.

The list returned by @code{cartesian_product_list} is equivalent to the
following recursive definition.
Let @var{L} be the list returned by @code{cartesian_product_list(@var{b_2}, ..., @var{b_n})}.
Then @code{cartesian_product_list(@var{b_1}, @var{b_2}, ..., @var{b_n})}
(i.e., @var{b_1} in addition to @var{b_2}, ..., @var{b_n})
returns a list comprising each element of @var{L} appended to the first element of @var{b_1},
each element of @var{L} appended to the second element of @var{b_1},
each element of @var{L} appended to the third element of @var{b_1}, etc.
The order of the list returned by @code{cartesian_product_list(@var{b_1}, @var{b_2}, ..., @var{b_n})}
...
if any argument @var{b_1}, ..., @var{b_n} contains duplicates.
In this respect, @code{cartesian_product_list} differs from @code{cartesian_product},
which returns no duplicates.
Also, the ordering of the list returned @code{cartesian_product_list}
is determined by the order of the elements of @var{b_1}, ..., @var{b_n}.
Again, this differs from @code{cartesian_product},
which returns a set (with order determined by @code{orderlessp}).

The length of the list returned by @code{cartesian_product_list}
is equal to the product of the lengths of the arguments @var{b_1}, ..., @var{b_n}.

See also @mrefdot{cartesian_product}

@code{cartesian_product_list} complains if any argument is not a list.

Examples:

@code{cartesian_product_list} returns a list of lists comprising all possible combinations.

@c ===beg===
@c cartesian_product_list ([0, 1]);
@c cartesian_product_list ([0, 1], [0, 1]);
@c cartesian_product_list ([x], [y], [z]);
