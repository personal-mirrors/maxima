...
@mrefdot{defrule}
@item aliases
All atoms which have an user-defined alias, created by the @mrefcomma{alias}@w{}
...
@c @deffn {Function} declare_index_properties (@var{a}, [@var{p_1}, @var{p_2}, @var{p_3}, ...])
@c @deffnx {Function} declare_index_properties ([@var{a}, @var{b}, @var{c}, ...], [@var{p_1}, @var{p_2}, @var{p_3}, ...])
@c @deffnx {Symbol} postsubscript
@c @deffnx {Symbol} postsuperscript
@c @deffnx {Symbol} presuperscript
