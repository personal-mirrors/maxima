...
@anchor{%rnum}
@c @defvr {System variable} %rnum
m4_defvr({System variable}, %rnum)
...
@c -----------------------------------------------------------------------------
@anchor{%rnum_list}
@c @defvr {System variable} %rnum_list
m4_defvr({System variable}, %rnum_list)
Default value: @code{[]}
...
@c -----------------------------------------------------------------------------
@anchor{algepsilon}
@c @defvr {Option variable} algepsilon
m4_defvr({Option variable}, algepsilon)
Default value: 10^8
...
@c -----------------------------------------------------------------------------
@anchor{algexact}
@c @defvr {Option variable} algexact
m4_defvr({Option variable}, algexact)
...
@c -----------------------------------------------------------------------------
@anchor{backsubst}
@c @defvr {Option variable} backsubst
m4_defvr({Option variable}, backsubst)
...
@c -----------------------------------------------------------------------------
@anchor{breakup}
@c @defvr {Option variable} breakup
m4_defvr({Option variable}, breakup)
Default value: @code{true}
...
@anchor{dispflag}
@c @defvr {Option variable} dispflag
m4_defvr({Option variable}, dispflag)
Default value: @code{true}
...
@anchor{globalsolve}
@c @defvr {Option variable} globalsolve
m4_defvr({Option variable}, globalsolve)
Default value: @code{false}
...
m4_setcat(Integral equations)
@anchor{ieqnprint}
@c @defvr {Option variable} ieqnprint
m4_defvr({Option variable}, ieqnprint)
Default value: @code{true}
...
one of the assignment operators @code{:= ::= : ::}, or an user-defined binary
...
m4_setcat(Linear equations)
@anchor{linsolvewarn}
@c @defvr {Option variable} linsolvewarn
m4_defvr({Option variable}, linsolvewarn)
Default value: @code{true}
...
@c @defvr {Option variable} linsolve_params
m4_defvr({Option variable}, linsolve_params)
Default value: @code{true}
...
@c -----------------------------------------------------------------------------
m4_setcat(Algebraic equations, Polynomials)
@anchor{multiplicities}
@c @defvr {System variable} multiplicities
m4_defvr({System variable}, multiplicities)
...
m4_setcat(Polynomials, Numerical methods)
@anchor{polyfactor}
@c @defvr {Option variable} polyfactor
m4_defvr({Option variable}, polyfactor)
Default value: @code{false}
...
m4_setcat(Algebraic equations, Polynomials)
@anchor{programmode}
@c @defvr {Option variable} programmode
m4_defvr({Option variable}, programmode)
Default value: @code{true}
...
m4_setcat(Algebraic equations)
@anchor{realonly}
@c @defvr {Option variable} realonly
m4_defvr({Option variable}, realonly)
Default value: @code{false}
...
@anchor{rootsconmode}
@c @defvr {Option variable} rootsconmode
m4_defvr({Option variable}, rootsconmode)
Default value: @code{true}
...
m4_setcat(Polynomials, Numerical methods)
@anchor{rootsepsilon}
@c @defvr {Option variable} rootsepsilon
m4_defvr({Option variable}, rootsepsilon)
...
@c @defvr {Option variable} solvedecomposes
m4_defvr({Option variable}, solvedecomposes)
Default value: @code{true}
...
@c @defvr {Option variable} solveexplicit
m4_defvr({Option variable}, solveexplicit)
Default value: @code{false}
...
@c -----------------------------------------------------------------------------
@anchor{solvefactors}
@c @defvr {Option variable} solvefactors
m4_defvr({Option variable}, solvefactors)
Default value: @code{true}
...
@c @defvr {Option variable} solvenullwarn
m4_defvr({Option variable}, solvenullwarn)
Default value: @code{true}
...
@c -----------------------------------------------------------------------------
@anchor{solveradcan}
@c @defvr {Option variable} solveradcan
m4_defvr({Option variable}, solveradcan)
Default value: @code{false}
...
@c @defvr {Option variable} solvetrigwarn
m4_defvr({Option variable}, solvetrigwarn)
Default value: @code{true}
