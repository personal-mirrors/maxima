...
@c -----------------------------------------------------------------------------
@node Introduction to linearalgebra, Functions and Variables for linearalgebra
...
@c -----------------------------------------------------------------------------
@need 800
@node Functions and Variables for linearalgebra,  , Introduction to linearalgebra
...
Find an entry in the sub-matrix @var{M} that satisfies some property.
Three cases:
...
this, an user must define functions for the arithmetic operations and
...
used), an user must define functions for the magnitude and for
