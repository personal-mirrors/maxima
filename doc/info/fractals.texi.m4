...
@node Introduction to fractals, Definitions for IFS fractals, fractals-pkg, fractals-pkg
...
@node Definitions for IFS fractals, Definitions for complex fractals, Introduction to fractals, fractals-pkg
...
Its default value is @mref{%i}; we  suggest the  values @code{-.745+%i*.113002}, 
...
@node Definitions for Peano maps,  , Definitions for Koch snowflakes, fractals-pkg
