...
@node Introduction to finance, Functions and Variables for finance, finance-pkg, finance-pkg
...
@node Functions and Variables for finance,  , Introduction to finance, finance-pkg
