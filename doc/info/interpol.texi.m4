...
@node Introduction to interpol, Functions and Variables for interpol, interpol-pkg, interpol-pkg
...
@node Functions and Variables for interpol,  , Introduction to interpol, interpol-pkg
...
See also @mrefcomma{lagrange}  @mrefcomma{linearinterpol}  @mrefcomma{cspline}  @mrefcomma{minpack_lsquares}  and @ref{lbfgs-pkg}
