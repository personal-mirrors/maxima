...
Pochhammer symbol and an unit step function. @code{orthopoly} uses 
...
If you need an unit step function that is neither left or right continuous
...
If you want an unit step function that
