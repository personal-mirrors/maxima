...
@code{[@var{x_1} = @var{a_1}, @dots{}, @var{x_n} = @var{a_n}]}
where @var{a_1}, @dots{}, @var{a_n} are all free of @var{x_1}, @dots{}, @var{x_n}.
...
@c @deffn {Function} grobner_basis ([@var{expr_1}, @dots{}, @var{expr_m}])
m4_deffn({Function}, grobner_basis, <<<([@var{expr_1}, @dots{}, @var{expr_m}])>>>)
...
m4_deffn( {Function}, declare_weights, <<<(@var{x_1}, @var{w_1}, @dots{}, @var{x_n}, @var{w_n})>>>)
Assigns weights @var{w_1}, @dots{}, @var{w_n} to @var{x_1}, @dots{}, @var{x_n}, respectively.
...
@anchor{nc_degree}
@c @deffn {Function} nc_degree (@var{p})
m4_deffn( {Function}, nc_degree, <<<(@var{p})>>>)
...
@anchor{dotsimp}
@c @deffn {Function} dotsimp (@var{f})
m4_deffn( {Function}, dotsimp, <<<(@var{f})>>>)
...
@c @deffn {Function} fast_central_elements ([@var{x_1}, @dots{}, @var{x_n}], @var{n})
m4_deffn( {Function}, fast_central_elements, <<<([@var{x_1}, @dots{}, @var{x_n}], @var{n})>>>)
If @code{set_up_dot_simplifications} has been previously done, finds the central polynomials
in the variables @var{x_1}, @dots{}, @var{x_n} in the given degree, @var{n}.
...
@c @deffn {Function} check_overlaps (@var{n}, @var{add_to_simps})
m4_deffn( {Function}, check_overlaps, <<<(@var{n}, @var{add_to_simps})>>>)
...
@anchor{mono}
@c @deffn {Function} mono ([@var{x_1}, @dots{}, @var{x_n}], @var{n})
m4_deffn( {Function}, mono, <<<([@var{x_1}, @dots{}, @var{x_n}], @var{n})>>>)
Returns the list of independent
monomials relative to the current dot simplifications of degree @var{n}
in the variables @var{x_1}, @dots{}, @var{x_n}.
...
@c @deffn {Function} monomial_dimensions (@var{n})
m4_deffn( {Function}, monomial_dimensions, <<<(@var{n})>>>)
...
@c @deffn {Function} extract_linear_equations ([@var{p_1}, @dots{}, @var{p_n}], [@var{m_1}, @dots{}, @var{m_n}])
m4_deffn( {Function}, extract_linear_equations, <<<([@var{p_1}, @dots{}, @var{p_n}], [@var{m_1}, @dots{}, @var{m_n}])>>>)

Makes a list of the coefficients of the noncommutative polynomials @var{p_1}, @dots{}, @var{p_n}
of the noncommutative monomials @var{m_1}, @dots{}, @var{m_n}.
...
or a list of polynomials @var{p_1}, @dots{}, @var{p_n}.
...
@c @defvr {Option variable} all_dotsimp_denoms
m4_defvr( {Option variable}, all_dotsimp_denoms)
